  ...
  return (
    <div>
      ...
      <div className='flex flex-col max-w-6xl gap-6 px-3 mx-auto p-28'>
        <h1 className='text-2xl font-bold text-slate-600 lg:text-6xl'>
        Investing in Spaces, Building Futures.
         
        </h1>
        <div className='text-xs text-gray-400 sm:text-sm'>
        NexGen Estate is the best place to find your next perfect place to live.
          <br />
